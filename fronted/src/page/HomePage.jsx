...
const HomePage = () => {
  return (
    <div className="min-h-screen flex flex-col items-center mt-14 px-4">
      ...
      <h1 className="text-4xl font-extrabold z-10 text-center">LeetLab</h1>
      <p className="mt-4 text-center text-lg font-semibold text-gray-50 dark:text-gray-400 z-10">
